package sbmsdk.aos.databinding.proxy
 ...
 * @author zoulinheng
 */
internal class ClickProxy(private var interval: Long = 1000, private val onClickListener: View.OnClickListener) : View.OnClickListener {
